...
func (m *mockToolPermRepo) Set(ctx context.Context, userID, toolName, mode string) error   { return m.err }
...
func (m *mockToolPermRepo) ListAll(ctx context.Context) ([]dto.ToolPermissionRecord, error) { return m.perms, m.err }
