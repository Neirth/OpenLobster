...
func (m *testMemoryPortWithGraph) AddKnowledge(context.Context, string, string, string, string, []float64) error { return nil }
func (m *testMemoryPortWithGraph) UpdateUserLabel(context.Context, string, string) error                         { return nil }
func (m *testMemoryPortWithGraph) SearchSimilar(context.Context, string, int) ([]ports.Knowledge, error)       { return nil, nil }
func (m *testMemoryPortWithGraph) GetUserGraph(ctx context.Context, userID string) (ports.Graph, error)        { return m.graph, nil }
func (m *testMemoryPortWithGraph) AddRelation(context.Context, string, string, string) error                   { return nil }
func (m *testMemoryPortWithGraph) QueryGraph(context.Context, string) (ports.GraphResult, error)               { return ports.GraphResult{}, nil }
func (m *testMemoryPortWithGraph) InvalidateMemoryCache(context.Context, string) error                          { return nil }
func (m *testMemoryPortWithGraph) SetUserProperty(context.Context, string, string, string) error               { return nil }
func (m *testMemoryPortWithGraph) EditMemoryNode(context.Context, string, string, string) error                { return nil }
...
func (m *testMemoryPortErr) AddKnowledge(context.Context, string, string, string, string, []float64) error { return nil }
func (m *testMemoryPortErr) UpdateUserLabel(context.Context, string, string) error                         { return nil }
func (m *testMemoryPortErr) SearchSimilar(context.Context, string, int) ([]ports.Knowledge, error)       { return nil, nil }
...
func (m *testMemoryPortErr) QueryGraph(context.Context, string) (ports.GraphResult, error) { return ports.GraphResult{}, nil }
func (m *testMemoryPortErr) InvalidateMemoryCache(context.Context, string) error          { return nil }
func (m *testMemoryPortErr) SetUserProperty(context.Context, string, string, string) error { return nil }
