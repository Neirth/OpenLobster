...
func (m *mockMemoryPortPartial) AddKnowledge(context.Context, string, string, string, string, []float64) error { return nil }
func (m *mockMemoryPortPartial) UpdateUserLabel(context.Context, string, string) error                           { return nil }
func (m *mockMemoryPortPartial) SearchSimilar(context.Context, string, int) ([]ports.Knowledge, error)         { return nil, nil }
func (m *mockMemoryPortPartial) AddRelation(context.Context, string, string, string) error                       { return nil }
func (m *mockMemoryPortPartial) QueryGraph(context.Context, string) (ports.GraphResult, error)                   { return ports.GraphResult{}, nil }
func (m *mockMemoryPortPartial) InvalidateMemoryCache(context.Context, string) error                             { return nil }
func (m *mockMemoryPortPartial) SetUserProperty(context.Context, string, string, string) error                  { return nil }
func (m *mockMemoryPortPartial) EditMemoryNode(context.Context, string, string, string) error                   { return nil }
