...
pdk.OutputString(`{"type":"object","properties":{"api_key":{"type":"string","title":"API Key"},"model":{"type":"string","title":"Model","default":"gpt-4o"},"base_url":{"type":"string","title":"Base URL (optional)"}},"required":["api_key"]}`)
return 0
}
...
opts = append(opts, option.WithBaseURL(input.Config.BaseURL))
}
